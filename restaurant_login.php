  ...
  <?php include "template/res-light-nav-bar.php"; ?>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($username_err) && empty($password_err)) {
            $sql =
                "SELECT restaurant_id, restaurant_username, restaurant_password FROM restaurant_account where restaurant_username=?";
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    if ($stmt->fetch()) {
                        ...
                        if ($password = $hashedpassword) {
                            session_start();
                            $_SESSION["restaurant_isLoggedIn"] = true;
                            $_SESSION["customer_isLoggedIn"] = false;
    ...
    <section class="home-slider owl-carousel" style="height: 400px;">
      <div class="slider-item" style="background-image: url('images/restologinbg.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center" style="padding-bottom: 25%;">

              <h1 class="mb-3">Restaurant Portal</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Restaurant Login</span>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    ...
                    <form action="<?php echo htmlspecialchars(
                      ...
                      <p class="text-center">Click here Register a Restaurant Account <a href="restaurant_signup.php">Click Here.</a></p>
